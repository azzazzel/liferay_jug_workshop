...
public class VenueLocalServiceUtil {
	...
	*/
	...
	public static int countGroupVenues(long companyId, long groupId) {
		return getService().countGroupVenues(companyId, groupId);
	}
	...
	*/
	public static java.util.List<bg.jug.workshop.liferay.cfp.model.Venue> getGroupVenues(
		...
		return getService().getGroupVenues(companyId, groupId, start, end);
	}
