...
public class VenueLocalServiceWrapper implements VenueLocalService,
	...
	*/
	...
	public int countGroupVenues(long companyId, long groupId) {
		return _venueLocalService.countGroupVenues(companyId, groupId);
	}
	...
	*/
	...
	public java.util.List<bg.jug.workshop.liferay.cfp.model.Venue> getGroupVenues(
		...
		return _venueLocalService.getGroupVenues(companyId, groupId);
	}
	...
	*/
	...
	public java.util.List<bg.jug.workshop.liferay.cfp.model.Venue> getGroupVenues(
		...
		return _venueLocalService.getGroupVenues(companyId, groupId, start, end);
	}
